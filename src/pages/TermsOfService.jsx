    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <main className="max-w-2xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
        ...
        <div className="mt-10 space-y-8 text-sm text-espresso/70 leading-relaxed">
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">9. Cancellations & Refunds</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">10. Prohibited Conduct</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">11. User Content & License Grant</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">12. Vision's Intellectual Property</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">13. Copyright Complaints</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">14. Third-Party Services</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">15. Disclaimers</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">16. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">17. Indemnification</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">18. Dispute Resolution & Arbitration</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">19. Termination</h2>
            <p>We reserve the right to suspend or terminate any account that violates these Terms, at our discretion and without prior notice. You may close your account at any time by contacting us at <a href={`mailto:${CONTACT}`} className="text-espresso font-semibold underline underline-offset-2 hover:opacity-70 transition-opacity">{CONTACT}</a>. Sections of these Terms that by their nature should survive termination (including Sections 11–18) will survive.</p>
          </section>

          <section>
            <h2 className="font-bold text-espresso text-base mb-2">20. Changes to Terms</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">21. Governing Law & Venue</h2>
            <p>These Terms are governed by the laws of the State of California, without regard to conflict of law principles. Subject to Section 18 (Dispute Resolution & Arbitration), any claim not subject to arbitration will be brought exclusively in the state or federal courts located in California, and you consent to that jurisdiction and venue.</p>
          </section>

          <section>
            <h2 className="font-bold text-espresso text-base mb-2">22. Miscellaneous</h2>
          ...
          <section>
            <h2 className="font-bold text-espresso text-base mb-2">23. Contact</h2>
